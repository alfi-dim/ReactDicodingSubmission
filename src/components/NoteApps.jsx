import {getActiveNotes, getArchivedNotes, showFormattedDate} from '../utils/local-data.js';
...
export default function NoteApps() {
  ...
  return (
    <>
      <Routes>
        <Route path="/" element={<NotesContainer notes={searchedActiveNotes ?? activeNotes} showFormattedDate={showFormattedDate} IconButtonProps={ActiveNotesIconButtonProps} handleSearchNote={handleSearchActiveNotesByTitle} headerTitle="Active Notes" ifNoteIsNullValue="There's no active notes here!" />} />
        <Route path='/archive'>
